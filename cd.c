...
/**
 * cd_dot - changes to the main directory
 * @datash: relevant file (environ)
 * Return: zero return
 */
...
/**
 * cd_to - changes to a directory that given by the user
 * @datash: relevant file (directories)
 * Return: return zero
 */
...
/**
 * cd_previous - changes to the old directory
 * @datash: relevant file (environ)
 * Return: zero return
 */
...
/**
 * cd_to_home - changes to host directory
 * @datash: relevant file (environ)
 * Return: zero return
 */
